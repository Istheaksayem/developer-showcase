...
export const projects: Project[] = [
  {
    ...
    liveUrl: "https://localchef-bazaar.example.com",
    githubUrl: "https://github.com/username/localchef-bazaar",
    challenges: [
  ...
  },
  {
    ...
    liveUrl: "https://freelance-marketplace.example.com",
    githubUrl: "https://github.com/username/freelance-marketplace",
    challenges: [
  ...
  {
    id: "skillswap-platform",
    title: "SkillSwap Learning Platform",
    description: "An e-learning platform for digital marketing and professional skill development.",
    image: project3,
    technologies: ["React", "Firebase", "Material UI", "Redux", "Node.js"],
    liveUrl: "https://skillswap-learning.example.com",
    githubUrl: "https://github.com/username/skillswap",
    challenges: [
      "Creating an engaging video player with progress tracking",
      "Building a certification system with verification",
      "Implementing interactive quizzes and assessments"
    ],
    improvements: [
      "Add live webinar capabilities",
      "Implement AI-powered learning paths",
      "Create mobile applications for offline learning"
    ],
    fullDescription: "SkillSwap is a comprehensive e-learning platform focused on digital marketing and professional development. It offers structured courses, hands-on projects, and industry-recognized certifications. The platform features progress tracking, peer learning, and mentor support."
  },
  {
